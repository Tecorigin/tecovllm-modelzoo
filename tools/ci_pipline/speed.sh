...
case "$MODEL_NAME" in
    OneGenomeRice)
        run_text "T1_in32768_out100"  16384   100  1   5  || rc=1
        run_text "T2_in32768_out100"  32768   100  1   5  || rc=1
        run_text "T3_in32768_out100"  65536   100  1   5  || rc=1
        run_text "T4_in102400_out100" 102400  100  1   5  || rc=1
        ;;
    *)
